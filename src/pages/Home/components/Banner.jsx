    ...
    <Box position="relative" sx={{mx: 3, pb: 5}}>
      ...
      <Grid container >
        ...
        <Grid item xs={12} md={6} position="relative" sx={{minHeight: "300px", mt: {xs: 5, md: 0}}}>
            <Box component="img" src={chip} alt="Chips" sx={{
              position: "absolute",
              height: 50,
              left: "20%",
              top: "10%",
            ...
            <Box sx={{
              ...
              <img alt="Chip bag" src={chip_bag} height="100%" style={{ transform: "rotate(-30deg)" }}/>
            </Box>
            <Box component="img" src={chocolate} alt="Chocolate" sx={{
              position: "absolute",
              height: 100,
              left: "70%",
              top: "40%",
            ...
            <Box component="img" alt="Pocky" src={pocky} sx={{
              position: "absolute",
              height: 80,
              left: "10%",
              top: "70%",
